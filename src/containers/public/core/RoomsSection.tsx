...
const RoomsSection = ({showHeader = false}: RoomsSectionProps) => {
    return (
        <section className="py-12 bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950" id="escape-rooms">
            <div className="container mx-auto px-6 lg:px-12">
                {showHeader && (
                    <div className="bg-clip-text text-transparent bg-gradient-to-b from-primary-400 to-primary-600">
                        <h2 className="text-3xl font-bold text-center mb-2">Unsere Räume</h2>
                        <p className="text-lg font-semibold text-center mb-8">Wir haben gleich {rooms.length} spannende
                            Räume für Sie.</p>
                    </div>
                )}
                ...
                {showHeader && (
                    <div className="mt-8 text-center">
                        <Link href="/escape-rooms" className="text-primary-500 hover:underline text-sm font-medium">
                            Alle Räume ansehen
                        </Link>
                    </div>
                )}
